...
def render_disease_risk(risk_prediction, crop_name):
    ...
    with col1:
        risk_label = t("severity.risk_" + risk_level.lower()) if risk_level.lower() in ["low", "medium", "high"] else risk_level
        st.markdown(f"""
            <div class="dashboard-card" style="text-align: center;">
...
def main():
    ...
    with col2:
        ...
        crop_name = st.selectbox(t("weather.select_crop"), SUPPORTED_CROPS, index=0)
