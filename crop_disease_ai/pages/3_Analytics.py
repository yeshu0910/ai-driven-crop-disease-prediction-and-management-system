...
def render_summary_cards(stats):
    ...
    metrics = [
        ...
        (
            "🦠",
            t("stats.common_disease"),
            stats.get("most_common_disease", "N/A"),
            "#e53935",
        ),
        ...
        (
            "🌾",
            t("analytics.stat_crops_monitored"),
            stats.get("total_crops", 0),
            "#1976d2",
        ),
        (
            "🦠",
            t("analytics.stat_common_disease"),
            stats.get("most_common_disease", "N/A"),
            "#e53935",
        ),
    ]
